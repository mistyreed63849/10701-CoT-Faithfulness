...
BATCH_SIZE = 1  
OUTPUT_FILE = "math_qwen_vllm.json"
...
math = load_dataset("DigitalLearningGmbH/MATH-lighteval", "default", streaming=True)
print("MATH streaming dataset ready")
